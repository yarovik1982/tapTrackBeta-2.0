      ...
      <div class="container-fluid">
        <div class="row row-cols-1 row-cols-md-2 g-4">
          <div class="col">
            <!-- <Card>
              <template #rating>
                <Rating class="starRating d-flex" v-model="ratingValue" :cancel="false" :stars="6">
                  <template #onicon>
            ...
            <div class="card mb-3 border-warning border-2 rounded rounded-4 bg-white bg-opacity-50" style="box-shadow: 0 0 20px 5px rgba(0, 0, 0, .5);">
              <div class="row g-0">
                <div class="col-md-4 p-2">
                  <img src="../assets/images/news1.jpg" class="img-fluid rounded rounded-4" alt="..." />
                </div>
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <p class="card-text">
                      Это более широкая карточка с вспомогательным текстом ниже
                      в качестве естественного перехода к дополнительному
                      контенту. Этот контент немного длиннее.
                    </p>
                    <p class="card-text">
