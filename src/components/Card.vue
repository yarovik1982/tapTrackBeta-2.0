...
const setCurrId = (item) => {
  formsStore.setCurrId(item.id)
}
</script>
<template>
  <div
  ...
  >
    <div class="row g-0 align-items-center">
      ...
      <div class="col-md-8 d-flex flex-column py-3" style="min-height: 525px;">
        <h5 class="card-title m-0 px-3">{{ item.name }}</h5>
        ...
        <div class="card_footer px-3">
          ...
          <div class="card-row justify-content-between py-3">
            ...
            <AppButton
              ...
              :item="item"
              :btn-class="'btn btn-outline-warning btn-sm rounded-5'"
              @on-click="openForm('createFeedback');setCurrId(item)"
